# Generalized Riemann Hypothesis — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/generalized-riemann-hypothesis-canonical-lane-mathlib.git
cd generalized-riemann-hypothesis-canonical-lane-mathlib
lake exe
lake build
```
